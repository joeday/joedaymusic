    ...
    <Layout home>
      <article className={styles.contactGrid}>
        ...
        <section className={styles.section}>
          <p>Want to go deeper? <a className={styles.emailLink} href="https://buttondown.email/joeday" target="_blank">Subscribe to my email list.</a> I send an email every 3-4 weeks. The emails can be anything from song stories to poems to playlists. But at the heart of the emails is the invitation to 2-way communication. I genuinely enjoy hearing from you and respond to every email that comes in. So, join the email list and let's talk.</p>
